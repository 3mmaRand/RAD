...
-  Arrange more random research and teaching events like the Away Day breakout sessions, to facilitate mixing across staff -  groups to brainstorm ideas and just chat
-  Review the induction and mentoring for new staff to facilitate more introductions and developing relationships across -  staff groups
-  Provide departmental pump priming to promote research and training interactions across groups developing new -  collaborations (could tie into the summer studentship scheme)
-  Support and expand the summer studentship schemes for UG, including funding and training for post-docs to participate as -  supervisors, and inter/multi-disciplinary projects crossing staff/lab groups
-  Develop structures by which post-docs can offer UG projects (especially stage 4 IM), with support from academic staff as a co-supervisor (ART or T&S), and recognition in workloads and pay (like GTA+ or contract variation)
-  Provide get-together sessions for e.g. all sci comm students and their directors, data science students and their -  directors, etc.
